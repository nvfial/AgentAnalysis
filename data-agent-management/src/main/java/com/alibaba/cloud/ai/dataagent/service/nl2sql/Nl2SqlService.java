...
public interface Nl2SqlService {
	...
	String generateSql(String query, String datasourceId);

	String generateSqlWithStreaming(String query, String datasourceId, String schemaContext, Consumer<String> chunkConsumer);
